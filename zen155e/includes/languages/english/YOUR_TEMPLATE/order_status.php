 ...
 * @version $Id: order_status.php 1.0 09/02/2017 davewest $
 */
...
define('TEXT_AD_BOX_ORDERS', 'Track your Order process easy and<br /> fast anytime from this page.<br />No need to Log In!');
